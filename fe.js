...
function generatedir(opt) {
    ...
    fs_1["default"].mkdirSync("".concat(projectName, "/test"));
    // 生成package.json
    ...
    function initGit(projectName) {
        ...
        fs_1["default"].writeFileSync("".concat(projectName, "/.gitignore"), "node_modules\n");
        (function () { return __awaiter(_this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, run("cd", [projectName])];
                    case 1:
                        _a.sent();
